...
from version1.compras.domain.entities import PedidoCompra, CabeceraPedidoCompra, LineaPedidoCompra
from version1.compras.application.create_pedido_pharma import PedidoCompraRepository
import pyodbc
