...
-- =============================================
-- 1) VENTAS: CABECERAS, LÍNEAS DE PEDIDO Y MOVIMIENTOS
-- =============================================

-- —– CABECERA PEDV001 (ABIERTO)
...
VALUES
  -- Movimientos de PEDV001
  ('MOVS001','PEDV001','1','COOP1','P1',
   'ALB001','1','2025-05-19','2025-05-19',
   NULL, 10,0, 0,'L001','2026-05-19','ALM1'),
  ('MOVS002','PEDV001','2','COOP1','P1',
   'ALB002','1','2025-05-20','2025-05-20',
   NULL,  6,1, 0,'L002','2026-05-20','ALM1'),
  -- Movimiento de PEDV002
  ('MOVS003','PEDV002','1','COOP2','P2',
   'ALB003','1','2025-05-17','2025-05-17',
   NULL,  8,0, 0,'L003','2026-05-17','ALM2');
GO


-- =============================================
-- 2) COMPRAS: CABECERAS, LÍNEAS DE PEDIDO Y MOVIMIENTOS
-- =============================================

-- —– CABECERA PCP001 (NORMAL)
INSERT INTO compras.compras_cabecera
   (num_pedido_compra, cod_cooperativa, puerta,
    cod_proveedor_cooperativa, tipo_pedido, dias_aplazamiento,
    pvl, pvl_neto, precio_libre, precio_libre_neto,
    dto_comercial, dto_logistico, dto_pronto_pago, dto_gestion,
    no_unnefar, fecha_pedido, fecha_prevista_entrega,
    num_acuerdo_compra, estado_pedido, almacen_origen_pedido_integrado,id_cooperativa)
VALUES
   ('PCP001','COOP1','P1','PROV01','NORMAL',30,
    200.00,180.00,220.00,198.00,
    5.00,2.00,1.00,0.50,
    0,'2025-05-14','2025-05-21',
    'ACC001','ABIERTO','ALM1','COOPPRUEBA');
...
VALUES
   (@cid1,'PCP001','1','ART123',12,
    10.00,120.00,11.00,132.00,
     1.00,0.50,0.25,0.10,
    'PCOOP001','ABIERTO'),
   (@cid1,'PCP001','2','ART456',20,
     8.50,170.00, 9.00,180.00,
     1.50,0.75,0.30,0.15,
    'PCOOP002','ABIERTO');
GO

-- —– CABECERA PCP002 (URGENTE)
INSERT INTO compras.compras_cabecera
   (num_pedido_compra, cod_cooperativa, puerta,
    cod_proveedor_cooperativa, tipo_pedido, dias_aplazamiento,
    pvl, pvl_neto, precio_libre, precio_libre_neto,
    ...
    num_acuerdo_compra, estado_pedido, almacen_origen_pedido_integrado,id_cooperativa)
VALUES
   ('PCP002','COOP2','P2','PROV02','URGENTE',15,
    350.00,315.00,380.00,342.00,
    10.00,3.00,1.50,0.75,
    1,'2025-05-10','2025-05-15',
    'ACC002','ABIERTO','ALM2','COOPPRUEBA');
...
VALUES
   (@cid2,'PCP002','1','ART789',5,
    40.00,200.00,45.00,225.00,
     2.00,1.00,0.50,0.25,
    'PCOOP003','ABIERTO'),
   (@cid2,'PCP002','2','ART321',10,
    25.00,250.00,28.00,280.00,
     3.00,1.50,0.75,0.35,
    'PCOOP004','ABIERTO');
GO

-- —– REPORTE DE MOVIMIENTOS DE COMPRAS
INSERT INTO compras.compras_reporte_movimientos
   (id_movimiento, num_pedido_compra, num_linea_pedido_compra,
    num_albaran, num_linea_albaran,
    fecha_generacion_albaran, fecha_real_movimiento,
    cantidad, motivo_devolucion,
    lote_calculado, lote, fecha_caducidad)
VALUES
